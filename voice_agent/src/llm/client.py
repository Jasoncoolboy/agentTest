"""Gemini LLM streaming client with tool calling support.



Uses Google's OpenAI-compatible Chat Completions API with streaming

responses and function calling.
...
# Gemini Developer API OpenAI-compat base URL
...
class LLMClient:
    ...
    """Streaming LLM client for Gemini (OpenAI-compatible endpoint)."""
